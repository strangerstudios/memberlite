...
?>
<li class="memberlite_active"><a href="#tab-comments" data-toggle="tab"><?php printf( __( 'Comments (%s)', 'memberlite' ), count( $memberlite_comments ) ); ?></a></li><?php } ?>
						<?php
						if ( count( $memberlite_trackbacks ) > 0 ) {
?>
<li><a href="#tab-tracks" data-toggle="tab"><?php printf( __( 'Trackbacks (%s)', 'memberlite' ), count( $memberlite_trackbacks ) ); ?></a></li><?php } ?>
						<?php
						if ( count( $memberlite_pingbacks ) > 0 ) {
?>
<li><a href="#tab-pings" data-toggle="tab"><?php printf( __( 'Pingbacks (%s)', 'memberlite' ), count( $memberlite_pingbacks ) ); ?></a></li><?php } ?>
					</ul>
