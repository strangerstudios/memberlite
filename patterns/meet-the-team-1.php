...
return [
	...
	'content'     => '<!-- wp:group {"align":"full","className":"is-style-default","backgroundColor":"site-navigation-background","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull is-style-default has-site-navigation-background-background-color has-background">
	...
	<div class="wp-block-columns alignwide">
		...
		<!-- wp:column {"verticalAlignment":"top","width":"70%","style":{"border":{"left":{"color":"var:preset|color|borders","width":"6px"}},"spacing":{"padding":{"left":"var:preset|spacing|30"}}}} -->
		<div class="wp-block-column is-vertically-aligned-top" style="border-left-color:var(--wp--preset--color--borders);border-left-width:6px;padding-left:var(--wp--preset--spacing--30);flex-basis:70%">
			<!-- wp:columns -->
