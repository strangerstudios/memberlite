...
<div class="wp-block-group alignfull">
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column">
			<!-- wp:image {"aspectRatio":"1","scale":"cover","align":"center","className":"is-style-rounded","style":{"border":{"radius":"100%"}}} -->
			<figure class="wp-block-image aligncenter has-custom-border is-style-rounded"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/patterns/people/samuel-raita-RiDxDgHg7pw-unsplash-sm.jpg alt="Photo of a man with thick black glasses and blond hair smiling and looking to the right." style="border-radius:100%;aspect-ratio:1;object-fit:cover"/></figure>
			<!-- /wp:image -->
			<!-- wp:paragraph {"align":"center"} -->
		...
		<div class="wp-block-column">
			<!-- wp:image {"aspectRatio":"1","scale":"cover","align":"center","className":"is-style-rounded","style":{"border":{"radius":"100%"}}} -->
			<figure class="wp-block-image aligncenter has-custom-border is-style-rounded"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/patterns/people/alex-starnes-WYE2UhXsU1Y-unsplash-sm.jpg alt="Photo of a smiling woman with short black curly hair and a white peasant style top standing in a clothing store." style="border-radius:100%;aspect-ratio:1;object-fit:cover"/></figure>
			<!-- /wp:image -->
			<!-- wp:paragraph {"align":"center"} -->
