 ...
 */
?>
<!-- wp:group {"align":"full","className":"footer-variation-05","style":{"spacing":{"padding":{"top":"var:preset|spacing|70","right":"var:preset|spacing|50","bottom":"var:preset|spacing|70","left":"var:preset|spacing|50"}},"elements":{"link":{"color":{"text":"var:preset|color|page-masthead"}}},"border":{"top":{"color":"var:preset|color|borders","width":"1px"},"right":{},"bottom":{"color":"var:preset|color|borders","width":"1px"},"left":{}}},"backgroundColor":"page-masthead-background","textColor":"page-masthead","layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull footer-variation-05 has-page-masthead-color has-page-masthead-background-background-color has-text-color has-background has-link-color" style="border-top-color:var(--wp--preset--color--borders);border-top-width:1px;border-bottom-color:var(--wp--preset--color--borders);border-bottom-width:1px;padding-top:var(--wp--preset--spacing--70);padding-right:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--70);padding-left:var(--wp--preset--spacing--50)"><!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|10"}},"layout":{"type":"constrained","contentSize":"600px"}} -->
<div class="wp-block-group"><!-- wp:heading {"textAlign":"center","textColor":"page-masthead","style":{"typography":{"fontWeight":"700"}},"fontSize":"36"} -->
<h2 class="wp-block-heading has-text-align-center has-page-masthead-color has-text-color has-36-font-size" style="font-weight:700"><?php esc_html_e( 'Ready to become a member?', 'memberlite' ); ?></h2>
<!-- /wp:heading -->

<!-- wp:paragraph {"align":"center","className":"has-text-align-center","textColor":"page-masthead"} -->
<p class="has-text-align-center has-text-align-center has-page-masthead-color has-text-color"><?php esc_html_e( 'Join thousands of members who are already learning, growing, and building connections in our community.', 'memberlite' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
...
<!-- wp:button {"backgroundColor":"color-action"} -->
<div class="wp-block-button"><a class="wp-block-button__link has-color-action-background-color has-background wp-element-button"><?php printf( '[fa icon="arrow-right-to-bracket"] %s', esc_html__( 'Log In', 'memberlite' ) ); ?></a></div>
<!-- /wp:button --></div>
<!-- /wp:buttons -->

<!-- wp:paragraph {"className":"has-text-align-center","style":{"typography":{"letterSpacing":"0.03em"}},"textColor":"page-masthead","fontSize":"14","fontFamily":"space-grotesk"} -->
<p class="has-text-align-center has-page-masthead-color has-text-color has-space-grotesk-font-family has-14-font-size" style="letter-spacing:0.03em"><?php esc_html_e( 'No long-term commitment required. Cancel anytime.', 'memberlite' ); ?></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
