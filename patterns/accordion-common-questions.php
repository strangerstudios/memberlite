 ...
 */
?>
<!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|10","left":"var:preset|spacing|10","top":"var:preset|spacing|50","bottom":"var:preset|spacing|50"}},"color":{"background":"#f4f4f4"}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group has-background" style="background-color:#f4f4f4;padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--10);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--10)"><!-- wp:heading {"style":{"typography":{"textAlign":"center","textTransform":"capitalize"}},"fontFamily":"work-sans"} -->
...
<!-- wp:accordion-panel {"style":{"elements":{"link":{"color":{"text":"var:preset|color|buttons"}}},"spacing":{"padding":{"top":"var:preset|spacing|20"}}},"backgroundColor":"site-navigation-background","textColor":"buttons"} -->
<div role="region" class="wp-block-accordion-panel has-buttons-color has-site-navigation-background-background-color has-text-color has-background has-link-color" style="padding-top:var(--wp--preset--spacing--20)"><!-- wp:paragraph -->
