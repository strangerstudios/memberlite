...
return [
	...
	'content'     => '<!-- wp:group {"align":"full","style":{"color":{"background":"#f1f1f1"},"spacing":{"margin":{"top":"0","bottom":"0"},"padding":{"top":"60px","bottom":"60px","left":"60px","right":"60px"}}},"layout":{"type":"constrained"}} -->
<div class="wp-block-group alignfull has-background" style="background-color:#f1f1f1;margin-top:0px;margin-bottom:0px;padding-top:60px;padding-right:60px;padding-bottom:60px;padding-left:60px">
	...
	<h2 class="wp-block-heading alignwide has-text-align-center has-text-color has-link-color" style="color:#000000;font-size:42px;font-style:normal">' . __( 'What Our Members Are Saying', 'memberlite' ) . '</h2>
	<!-- /wp:heading -->	
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group has-border-color has-text-color has-background has-link-color" style="border-color:#e0e0e0;border-width:1px;border-radius:12px;color:#000000;background-color:#ffffff;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px">
				...
				<div class="wp-block-group">
					...
					<!-- /wp:paragraph -->
					<!-- wp:paragraph {"style":{"typography":{"fontSize":"18px"}}} -->
					<p style="font-size:18px">' . __( 'The member community alone is worth the price. I have connected with people who truly understand what I am building. We support each other, share wins, and help solve problems together.', 'memberlite' ) . '</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
				<!-- wp:group {"layout":{"type":"flex","flexWrap":"wrap"}} -->
		...
		<div class="wp-block-column">
			...
			<div class="wp-block-group has-border-color has-text-color has-background has-link-color" style="border-color:#e0e0e0;border-width:1px;border-radius:12px;color:#000000;background-color:#ffffff;padding-top:30px;padding-right:30px;padding-bottom:30px;padding-left:30px">
				...
				<div class="wp-block-group">
					...
					<!-- /wp:paragraph -->
					<!-- wp:paragraph {"style":{"typography":{"fontSize":"18px"}}} -->
					<p style="font-size:18px">' . __( 'As a nonprofit volunteer, I needed affordable resources I could trust. This membership gave me exactly that. Reliable tools, clear guidance, and a community that understands working with limited budgets.', 'memberlite' ) . '</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
				<!-- wp:group {"layout":{"type":"flex","flexWrap":"wrap"}} -->
				<div class="wp-block-group">
					<!-- wp:image {"width":"100px","aspectRatio":"1","scale":"cover","style":{"border":{"radius":"100%"}},"className":"is-style-rounded"} -->
					<figure class="wp-block-image is-resized has-custom-border is-style-rounded"><img src="' . esc_url( get_template_directory_uri() . '/assets/images/patterns/people/constantin-panagopoulos-9lf_erPHYG0-unsplash-md.jpg' ) . '" alt="' . __( 'Close up photo of smiling woman wearing a straw hat and black top.', 'memberlite' ) . '" style="border-radius:100%;aspect-ratio:1;object-fit:cover;width:100px"/></figure>
					<!-- /wp:image -->
					<!-- wp:paragraph {"style":{"typography":{"fontSize":"18px"}}} -->
					<p style="font-size:18px"><strong>' . __( 'Ashley Hoyt', 'memberlite' ) . '</strong><br />' . __( 'Nonprofit Volunteer', 'memberlite' ) . '</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
