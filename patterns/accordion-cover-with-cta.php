...
<p class="has-color-secondary-color has-text-color has-link-color has-roboto-font-family has-21-font-size" style="letter-spacing:1px"><strong>Community</strong> <strong>Benefits</strong></p>
<!-- /wp:paragraph -->

<!-- wp:heading {"style":{"typography":{"fontSize":"35px","textTransform":"capitalize"},"spacing":{"margin":{"top":"var:preset|spacing|10","bottom":"0"}}},"fontFamily":"libre-baskerville"} -->
<h2 class="wp-block-heading has-libre-baskerville-font-family" style="margin-top:var(--wp--preset--spacing--10);margin-bottom:0;font-size:35px;text-transform:capitalize"><strong>What </strong>you need to know about our joining the community</h2>
<!-- /wp:heading -->
