...
<div class="wp-block-column" style="padding-right:var(--wp--preset--spacing--20)"><!-- wp:paragraph {"style":{"elements":{"link":{"color":{"text":"var:preset|color|color-action"}}},"typography":{"letterSpacing":"1px","textTransform":"capitalize"}},"textColor":"color-action","fontSize":"21"} -->
<p class="has-color-action-color has-text-color has-link-color has-21-font-size" style="letter-spacing:1px;text-transform:capitalize"><strong>Community benefits</strong></p>
<!-- /wp:paragraph -->
