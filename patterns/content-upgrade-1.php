<?php
/**
 * Title: Content Upgrade 1
 * Slug: memberlite/content-upgrade-1
 * Description: Simple text "content upgrade" call to action to build your email list or promote offers.
	...
	<div class="wp-block-group has-border-color has-borders-border-color" style="border-width:1px;border-radius:8px;margin-top:var(--wp--preset--spacing--70);margin-bottom:var(--wp--preset--spacing--70);padding-top:var(--wp--preset--spacing--20);padding-right:var(--wp--preset--spacing--20);padding-bottom:var(--wp--preset--spacing--20);padding-left:var(--wp--preset--spacing--20)">
		...
		<div class="wp-block-columns">
			...
			<div class="wp-block-column" style="flex-basis:70%">
				...
				<p class="has-large-font-size"><strong>Get started for free.</strong></p>
				<!-- /wp:paragraph -->
				<!-- wp:paragraph -->
				<p>Start with our free resources to see if this community is right for you. No commitment required.</p>
				<!-- /wp:paragraph -->
			</div>
			<!-- /wp:column -->
