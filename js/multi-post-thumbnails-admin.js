window.MemberliteMultiPostThumbnails = {
    ...
    removeThumbnail: function(id, post_type, nonce){
	    jQuery.post(ajaxurl, {
		    ...
		    if ( str == '0' ) {
			    ...
			    MemberliteMultiPostThumbnails.setThumbnailHTML(str, id, post_type);
		    }
	    }
	    );
    },
    ...
    setAsThumbnail: function(thumb_id, id, post_type, nonce){
	    ...
	    jQuery.post(ajaxurl, {
		    ...
		    if ( str == '0' ) {
			    ...
			    win.MemberliteMultiPostThumbnails.setThumbnailID(thumb_id, id, post_type);
			    win.MemberliteMultiPostThumbnails.setThumbnailHTML(str, id, post_type);
		    }
	    }
	    );
    }
