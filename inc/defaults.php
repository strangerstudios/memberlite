...
$memberlite_defaults = apply_filters( 'memberlite_defaults', array(
	...
	'color_link_color_elements'                 => '.content-area a:link:not(.wp-block-button__link):not(.btn), .footer-navigation a, .site-info a',
	//'color_link_hover_elements'                 => '.content-area a:hover:not(.wp-block-button__link):not(.btn), .footer-navigation a:hover, .site-info a:hover',
