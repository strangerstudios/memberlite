...
$memberlite_defaults = array(
	...
	'color_secondary_background_elements' => '#meta-member aside, #meta-member .member-navigation .sub-menu, .btn_secondary, .btn_secondary:link, .btn_primary:hover, .pmpro_content_message a:hover, .woocommerce button.button.alt:hover, .woocommerce input.button.alt:hover, .woocommerce-page #content input.button.alt:hover, .woocommerce-page #respond input#submit.alt:hover, .woocommerce-page a.button.alt:hover, .woocommerce-page button.button.alt:hover, .woocommerce-page input.button.alt:hover, .memberlite_tabbable ul.memberlite_tabs li.memberlite_active a:hover, .banner_secondary',
	'color_secondary_background_hover_elements' => '.btn_secondary:hover, .pmpro_content_message a:hover, .woocommerce button.button.alt:hover, .woocommerce input.button.alt:hover, .woocommerce-page #content input.button.alt:hover, .woocommerce-page #respond input#submit.alt:hover, .woocommerce-page a.button.alt:hover, .woocommerce-page button.button.alt:hover, .woocommerce-page input.button.alt:hover, .memberlite_tabbable ul.memberlite_tabs li.memberlite_active a:hover',
