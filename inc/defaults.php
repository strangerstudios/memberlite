...
$memberlite_defaults = array(
	...
	'posts_entry_meta_before' => 'Posted on {post_date} by {post_author_posts_link}',	
	...
	'color_secondary_background_elements' => '#meta-member aside, #meta-member .member-navigation .sub-menu, .btn_secondary, .btn_secondary:link, .memberlite_tabbable ul.memberlite_tabs li.memberlite_active a, .memberlite_tabbable ul.memberlite_tabs li.memberlite_active a:hover, .banner_secondary, #banner_bottom',
