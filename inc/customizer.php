...
class Memberlite_Customize {
	 ...
	 *
	 * @param string|null $current_scheme Optional. The current scheme value.
	...
	public static function get_dynamic_color_scheme_choices() {
		...
		$choices['custom'] = __( 'Custom Colors', 'memberlite' );
	...
	public static function header_output() {
		...
		<style id="memberlite-customizer-css" type="text/css">
			:root {
				...
				/* Memberlite-specific color variables */
	...
	/**
	 * Returns an array of color schemes registered for Memberlite.
	 *
	 * @since 1.0
	 * @since TBD Updated to return global variable.
	 * 
	...
	/**
	 * Returns an array of legacy color schemes (pre-6.6.1) registered for Memberlite.
	 *
	 * @since TBD
	 *
	 * @return array Array of legacy color schemes.
	 */
