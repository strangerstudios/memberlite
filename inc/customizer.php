...
class Memberlite_Customize {
	...
	public static function register( WP_Customize_Manager $wp_customize ) {
		...
		// General Settings
		self::set_general_settings( $wp_customize );
	...
	public static function set_general_settings( WP_Customize_Manager $wp_customize ) {
		...
		// GENERAL: Back to Top Link =============
		self::add_memberlite_setting_control( $wp_customize, 'memberlite_back_to_top', __( 'Show Back to Top Link', 'memberlite' ), 'memberlite_general_options', array(
			'type'              => 'checkbox',
			'default'           => true,
...
function memberlite_is_legacy_footer_active(): bool {
	if ( get_theme_mod( 'memberlite_global_footer_slug', '0' ) !== '0' ) {
		return false;
	}

	$footer_posts = memberlite_get_footer_variations();
