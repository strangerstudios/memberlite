	...
	<div id="wpbody-content" aria-label="Main content" tabindex="0">	
		...
		<div class="wrap about-wrap">
			...
			<div class="feature-section two-col">
				...
				<div class="col">
					<h2><span class="dashicons dashicons-admin-customizer"></span> <?php _e( 'Customize the Theme' ,
'memberlite' ); ?></h2>
...
'memberlite' ); ?></a>
				...
				<hr />
				<div class="col">
					<h2><span class="dashicons dashicons-admin-appearance"></span> <?php _e( 'Using Child Themes' ,
'memberlite' ); ?></h2>
					<p><?php _e( 'If you need to customize the theme beyond the settings in Appearance > Customize, use a child theme.' ,
'memberlite' ); ?></p>
					<p>
						<a class="button button-primary"href="https://github.com/strangerstudios/memberlite-child" target="_blank"><?php _e( 'Download a Blank Child Theme' ,
'memberlite' ); ?></a>
						<a class="button" href="https://developer.wordpress.org/themes/advanced-topics/child-themes/" target="_blank"><?php _e( 'About Child Themes (WordPress Codex)', 
'memberlite' ); ?></a>
					</p>
				</div>
				<div class="col">
					<h2><span class="dashicons dashicons-lightbulb"></span> <?php _e( 'Theme Demo, Docs and Support' ,
'memberlite' ); ?></h2>
					<p><?php _e( 'We offer a simple annual support membership if you need additional help with your Memberlite-powered WordPress site.' ,
'memberlite' ); ?></p>
					<p>
						<a class="button button-primary" href="https://demo.memberlitetheme.com" target="_blank"><?php _e( 'View Theme Demo' ,
'memberlite' ); ?></a>
						<a class="button" href="https://memberlitetheme.com" target="_blank"><?php _e( 'View All Docs and Get Support', 
'memberlite' ); ?></a>
					</p>
				</div>
			...
			<br class="clear" />
			<hr />
			<h2><?php _e( 'Upgrading from Memberlite v2.0?' ,
'memberlite' ); ?></h2>
			<div class="wrap">
			...
			<br class="clear" />
			<hr />
			<h2><?php _e( 'We highly recommend using these plugins for every site running Memberlite:' ,
'memberlite' ); ?></h2>
					...
					<div class="plugin-card plugin-card-memberlite-shortcodes">
						<div class="plugin-card-top">
							<div class="name column-name">
								<h3>
									<a href="https://memberlitetheme.com/memberlite-shortcodes/" target="_blank"><?php _e( 'Memberlite Shortcodes' ,
'memberlite' ); ?></a>
									...
									<li>
										<?php 
											if( is_plugin_active( 'memberlite-shortcodes/memberlite-shortcodes.php' ) ) { ?>
												<a class="button button-disabled"><?php _e( 'Installed' ,
'memberlite' ); ?></a>
											<?php } else { ?>
												<a class="install-now button" href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&s=memberlite+shortcodes') ); ?>"><?php _e( 'Install Now' ,
'memberlite' ); ?></a>
											<?php } ?>
									</li>
									<li><a href="https://memberlitetheme.com/memberlite-shortcodes/" target="_blank"><?php _e( 'More Details' ,
'memberlite' ); ?></a></li>
								</ul>
							</div>
							<div class="desc column-description">
								<p><?php _e( 'Enhance the appearance of your content with shortcodes for Banners, Buttons, Columns, Icons, Membership Signup Block, Messages, and Recent Posts.', 
'memberlite' ); ?></p>
								<p class="authors"><cite><?php _e( 'By', 
'memberlite' ); ?> <a href="https://www.strangerstudios.com"><?php _e( 'Stranger Studios', 
'memberlite' ); ?></a></cite></p>
							</div>
						</div>
					...
					<div class="plugin-card plugin-card-paid-memberships-pro">
						<div class="plugin-card-top">
							<div class="name column-name">
								<h3>
									<a href="https://www.paidmembershipspro.com" target="_blank"><?php _e( 'Paid Memberships Pro' ,
'memberlite' ); ?></a>
							...
							<div class="action-links">
								<ul class="plugin-action-buttons">
									<li>
										<a class="install-now button" href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&s=paid+memberships+pro') ); ?>"><?php _e( 'Install Now' ,
'memberlite' ); ?></a>
									</li>
									<li><a href="https://www.paidmembershipspro.com" target="_blank"><?php _e( 'More Details' ,
'memberlite' ); ?></a></li>
								</ul>
							</div>
							<div class="desc column-description">
								<p><?php _e( 'A revenue-generating machine for membership sites. Unlimited levels with recurring payment, protected content and member management.', 
'memberlite' ); ?></p>
								<p class="authors"><cite><?php _e( 'By', 
'memberlite' ); ?> <a href="https://www.strangerstudios.com"><?php _e( 'Stranger Studios', 
'memberlite' ); ?></a></cite></p>
					...
					<div class="plugin-card plugin-card-multiple-post-thumbnails">
						<div class="plugin-card-top">
							<div class="name column-name" style="margin-left: 0;">
								<h3>
									<a href="https://wordpress.org/plugins/multiple-post-thumbnails/" target="_blank"><?php _e( 'Multiple Post Thumbnails' ,
'memberlite' ); ?></a>
								</h3>
							</div>
							<div class="action-links">
								<ul class="plugin-action-buttons">
									<li>
										<a class="install-now button" href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&s=multiple+post+thumbnails') ); ?>"><?php _e( 'Install Now' ,
'memberlite' ); ?></a>
									</li>
									<li><a href="https://wordpress.org/plugins/multiple-post-thumbnails/" target="_blank"><?php _e( 'More Details' ,
'memberlite' ); ?></a></li>
								</ul>
							</div>
							<div class="desc column-description" style="margin-left: 0;">
								<p><?php _e( 'Adds multiple post thumbnails to a post type. Required if you want to use the banner image/thumbnail features in Memberlite.', 
'memberlite' ); ?></p>
								<p class="authors"><cite><?php _e( 'By', 
'memberlite' ); ?> <a href="http://voceplatforms.com/"><?php _e( 'Chris Scott', 
'memberlite' ); ?></a></cite></p>
							</div>
						</div>
					...
					<div class="plugin-card plugin-card-theme-my-login">
						<div class="plugin-card-top">
							<div class="name column-name">
								<h3>
									<a href="https://www.jfarthing.com/development/theme-my-login/" target="_blank"><?php _e( 'Theme My Login' ,
'memberlite' ); ?></a>
							...
							<div class="action-links">
								<ul class="plugin-action-buttons">
									<li>
										<a class="install-now button" href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&s=theme+my+login') ); ?>"><?php _e( 'Install Now' ,
'memberlite' ); ?></a>
									</li>
									<li><a href="https://www.jfarthing.com/development/theme-my-login/" target="_blank"><?php _e( 'More Details' ,
'memberlite' ); ?></a></li>
								</ul>
							</div>
							<div class="desc column-description">
								<p><?php _e( 'Themes the WordPress login and profile pages according to your theme. Additional settings for restricting admin access and redirection.', 
'memberlite' ); ?></p>
								<p class="authors"><cite><?php _e( 'By', 
'memberlite' ); ?> <a href="https://www.jfarthing.com"><?php _e( 'Jeff Farthing', 
'memberlite' ); ?></a></cite></p>
							</div>
						</div>
					...
					<div class="plugin-card plugin-card-pmpro-advanced-levels-shortcode">
						<div class="plugin-card-top">
							<div class="name column-name" style="margin-left: 0;">
								<h3>
									<a href="https://www.paidmembershipspro.com/add-ons/pmpro-advanced-levels-shortcode/" target="_blank"><?php _e( 'Advanced Levels Page Shortcode' ,
'memberlite' ); ?></a>									
								</h3>
							</div>
							<div class="action-links">
...
'memberlite' ); ?></a>
									...
									<li><a href="https://www.paidmembershipspro.com/add-ons/pmpro-advanced-levels-shortcode/" target="_blank"><?php _e( 'More Details' ,
'memberlite' ); ?></a></li>
								</ul>
							</div>
							<div class="desc column-description" style="margin-left: 0;">
								<p><?php _e( 'Adds a new shortcode with many attributes to customize the levels page, including integrated styles for widely used theme frameworks/parent themes.', 
'memberlite' ); ?></p>
								<p class="authors"><cite><?php _e( 'By', 
'memberlite' ); ?> <a href="https://www.strangerstudios.com"><?php _e( 'Stranger Studios', 
'memberlite' ); ?></a></cite></p>
			...
			<h2><?php _e( 'Memberlite offers integration for these recommended plugins:' ,
'memberlite' ); ?></h2>		
			<div class="wp-list-table widefat plugin-install">
				<h2 class="screen-reader-text">Plugins list</h2>	
				<div id="the-list">
					<div class="plugin-card plugin-card-bbpress">
						<div class="plugin-card-top">
							<div class="name column-name">
								<h3>
									<a href="https://www.bbpress.org" target="_blank"><?php _e( 'bbPress' ,
'memberlite' ); ?></a>
							...
							<div class="action-links">
								<ul class="plugin-action-buttons">
									<li>
										<a class="install-now button" href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&s=bbpress') ); ?>"><?php _e( 'Install Now' ,
'memberlite' ); ?></a>
									</li>
									<li><a href="https://www.bbpress.org" target="_blank"><?php _e( 'More Details' ,
'memberlite' ); ?></a></li>
								</ul>
							</div>
							<div class="desc column-description">
								<p><?php _e( 'bbPress is forum software, made the WordPress way.', 
'memberlite' ); ?></p>
								<p><a href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&type=term&s=Paid+Memberships+Pro+-+bbPress+Add+On') ); ?>"><?php _e( 'Install Paid Memberships Pro - bbPress Add On' ,
'memberlite' ); ?></a></p>
								<p class="authors"><cite><?php _e( 'By', 
'memberlite' ); ?> <a href="https://www.bbpress.org"><?php _e( 'The bbPress Community', 
'memberlite' ); ?></a></cite></p>
							</div>
						</div>
					...
					<div class="plugin-card plugin-card-events-manager">
						<div class="plugin-card-top">
							<div class="name column-name">
								<h3>
									<a href="http://wp-events-plugin.com" target="_blank"><?php _e( 'Events Manager' ,
'memberlite' ); ?></a>
							...
							<div class="action-links">
								<ul class="plugin-action-buttons">
									<li>
										<a class="install-now button" href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&s=events+manager') ); ?>"><?php _e( 'Install Now' ,
'memberlite' ); ?></a>
									</li>
									<li><a href="http://wp-events-plugin.com" target="_blank"><?php _e( 'More Details' ,
'memberlite' ); ?></a></li>
								</ul>
							</div>
							<div class="desc column-description">
								<p><?php _e( 'Fully featured event registration management including recurring events, locations management, calendar, Google map integration, booking management', 
'memberlite' ); ?></p>
								<p class="authors"><cite><?php _e( 'By', 
'memberlite' ); ?> <a href="http://wp-events-plugin.com"><?php _e( 'Marcus Sykes', 
'memberlite' ); ?></a></cite></p>
							</div>
						</div>
...
'memberlite' ); ?></a></cite></p>
					...
					<div class="plugin-card plugin-card-testimonials-widget">
						<div class="plugin-card-top">
							<div class="name column-name" style="margin-left: 0;">
								<h3>
									<a href="https://wordpress.org/plugins/testimonials-widget/" target="_blank"><?php _e( 'Testimonials Widget' ,
'memberlite' ); ?></a>
								</h3>
							</div>
							<div class="action-links">
								<ul class="plugin-action-buttons">
									<li>
										<a class="install-now button" href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&s=') ); ?>"><?php _e( 'Install Now' ,
'memberlite' ); ?></a>
									</li>
									<li><a href="https://wordpress.org/plugins/testimonials-widget/" target="_blank"><?php _e( 'More Details' ,
'memberlite' ); ?></a></li>
								</ul>
							</div>
							<div class="desc column-description" style="margin-left: 0;">
								<p><?php _e( 'Easily add social proofing to your website with Testimonials Widget. List or slide reviews via functions, shortcodes, or widgets.', 
'memberlite' ); ?></p>
								<p class="authors"><cite><?php _e( 'By', 
'memberlite' ); ?> <a href="https://wordpress.org/plugins/testimonials-widget/"><?php _e( 'Axelerant', 
'memberlite' ); ?></a></cite></p>
							</div>
						</div>
					...
					<div class="plugin-card plugin-card-woocommerce">
						<div class="plugin-card-top">
							<div class="name column-name">
								<h3>
									<a href="https://woocommerce.com" target="_blank"><?php _e( 'WooCommerce' ,
'memberlite' ); ?></a>
							...
							<div class="action-links">
								<ul class="plugin-action-buttons">
									<li>
										<a class="install-now button" href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&s=woocommerce') ); ?>"><?php _e( 'Install Now' ,
'memberlite' ); ?></a>
									</li>
									<li><a href="" target="_blank"><?php _e( 'More Details' ,
'memberlite' ); ?></a></li>
								</ul>
							</div>
							<div class="desc column-description">
								<p><?php _e( 'WooCommerce is a powerful, extendable eCommerce plugin that helps you sell anything. Beautifully.', 
'memberlite' ); ?></p>
								<p><a href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&type=term&s=Paid+Memberships+Pro+-+WooCommerce+Add+On') ); ?>"><?php _e( 'Install Paid Memberships Pro - WooCommerce Add On' ,
'memberlite' ); ?></a></p>
								<p class="authors"><cite><?php _e( 'By', 
'memberlite' ); ?> <a href="https://woocommerce.com"><?php _e( 'WooThemes', 
'memberlite' ); ?></a></cite></p>
							</div>
						</div>
...
function memberlite_admin_notice_install_memberlite_shortcodes() {
	...
	if( file_exists( WP_PLUGIN_DIR . '/memberlite-shortcodes/memberlite-shortcodes.php' ) ) {
		...
		$click_text = __( 'Click here to activate the Memberlite Shortcodes plugin.', 
'memberlite' );
	} else {
		// need to install
		...
		$click_text = __( 'Click here to install the Memberlite Shortcodes plugin.', 
'memberlite' );
	}
	...
	<div id="memberlite-admin-notice-install_memberlite_shortcodes" class="notice notice-error is-dismissible memberlite-notice"> 
		<p><strong><?php _e( 'Memberlite', 
'memberlite' ); ?>:</strong> <?php echo __( 'Some features of Memberlite now require the Memberlite Shortcodes plugin.', 'memberlite' ) . ' <a href="' . $click_link . '">' . $click_text . '</a>';?></p>
	</div>
	<?php
}
...
function memberlite_admin_notice_install_advanced_levels_shortcode() {
	...
	if( file_exists( WP_PLUGIN_DIR . '/pmpro-advanced-levels-shortcode/pmpro-advanced-levels-shortcode.php' ) ) {
		...
		$click_text = __( 'Click here to activate the Advanced Levels Shortcode plugin.', 
'memberlite' );
	} else {
		// need to install
		...
		$click_text = __( 'Click here to install the Advanced Levels Shortcode plugin.', 
'memberlite' );
	}
	...
	<div id="memberlite-admin-notice-install_advanced_levels_shortcode" class="notice notice-error is-dismissible memberlite-notice"> 
		<p><strong><?php _e( 'Memberlite', 
'memberlite' );?>:</strong> <?php echo __( 'The [memberlite_levels] shortcode has been merged into the Advanced Levels Shortcode add on.', 'memberlite' ) . ' <a href="' . $click_link . '">' . $click_text . '</a>';?></p>
	</div>
	<?php
}
=======
...
?>
						...
						<a class="button" href="https://memberlitetheme.com/documentation/customize/" target="_blank">
						<?php
						_e(
							'View Docs on on Customizing Memberlite',
							'memberlite'
						);
?>
</a>
...
?>
					...
					<?php
					_e(
						'If you need to customize the theme beyond the settings in Appearance > Customize, use a child theme.',
						'memberlite'
					);
?>
</p>
...
?>
						...
						<?php
						_e(
							'About Child Themes (WordPress Codex)',
							'memberlite'
						);
?>
</a>
...
?>
					...
					<?php
					_e(
						'We offer a simple annual support membership if you need additional help with your Memberlite-powered WordPress site.',
						'memberlite'
					);
?>
</p>
					<p>
						<a class="button button-primary" href="https://demo.memberlitetheme.com" target="_blank">
						<?php
						_e(
							'View Theme Demo',
							'memberlite'
...
?>
						...
						<a class="button" href="https://memberlitetheme.com" target="_blank">
						<?php
						_e(
							'View All Docs and Get Support',
							'memberlite'
						);
?>
</a>
				...
				<div id="the-list">
					<div class="plugin-card plugin-card-memberlite-shortcodes">
						<div class="plugin-card-top">
							<div class="name column-name">
								<h3>
									<a href="https://memberlitetheme.com/memberlite-shortcodes/" target="_blank">
									<?php
									_e(
...
?>
									...
									<li><a href="https://memberlitetheme.com/memberlite-shortcodes/" target="_blank">
									<?php
									_e(
										'More Details',
										'memberlite'
...
?>
									...
									<li><a href="https://www.paidmembershipspro.com" target="_blank">
									<?php
									_e(
										'More Details',
										'memberlite'
...
?>
							...
							<div class="action-links">
								<ul class="plugin-action-buttons">
									<li>
										<a class="install-now button" href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&s=multiple+post+thumbnails' ) ); ?>">
																						<?php
																						_e(
																							'Install Now',
																							'memberlite'
...
?>
									...
									<li><a href="https://wordpress.org/plugins/multiple-post-thumbnails/" target="_blank">
									<?php
									_e(
										'More Details',
										'memberlite'
...
?>
							...
							<div class="desc column-description" style="margin-left: 0;">
								...
								<?php
								_e(
									'Adds multiple post thumbnails to a post type. Required if you want to use the banner image/thumbnail features in Memberlite.',
									'memberlite'
								);
?>
</p>
...
?>
							...
							<div class="action-links">
								<ul class="plugin-action-buttons">
									<li>
										<a class="install-now button" href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&s=theme+my+login' ) ); ?>">
																						<?php
																						_e(
																							'Install Now',
																							'memberlite'
...
?>
							...
							<div class="desc column-description">
								...
								<?php
								_e(
									'Themes the WordPress login and profile pages according to your theme. Additional settings for restricting admin access and redirection.',
									'memberlite'
								);
?>
</p>
...
?>
							...
							<div class="desc column-description" style="margin-left: 0;">
								...
								<?php
								_e(
									'Adds a new shortcode with many attributes to customize the levels page, including integrated styles for widely used theme frameworks/parent themes.',
									'memberlite'
								);
?>
</p>
...
?>
			...
			<?php
			_e(
				'Memberlite offers integration for these recommended plugins:',
				'memberlite'
			);
?>
</h2>		
...
?>
							...
							<div class="action-links">
								<ul class="plugin-action-buttons">
									<li>
										<a class="install-now button" href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&s=bbpress' ) ); ?>">
																						<?php
																						_e(
																							'Install Now',
																							'memberlite'
...
?>
									...
									<li><a href="https://www.bbpress.org" target="_blank">
									<?php
									_e(
										'More Details',
										'memberlite'
...
?>
								...
								<p><a href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&type=term&s=Paid+Memberships+Pro+-+bbPress+Add+On' ) ); ?>">
														<?php
														_e(
															'Install Paid Memberships Pro - bbPress Add On',
															'memberlite'
														);
?>
</a></p>
...
?>
							...
							<div class="action-links">
								<ul class="plugin-action-buttons">
									<li>
										<a class="install-now button" href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&s=events+manager' ) ); ?>">
																						<?php
																						_e(
																							'Install Now',
																							'memberlite'
...
?>
									...
									<li><a href="http://wp-events-plugin.com" target="_blank">
									<?php
									_e(
										'More Details',
										'memberlite'
...
?>
							...
							<div class="action-links">
								<ul class="plugin-action-buttons">
									<li>
										<a class="install-now button" href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&s=' ) ); ?>">
																						<?php
																						_e(
																							'Install Now',
																							'memberlite'
...
?>
									...
									<li><a href="https://wordpress.org/plugins/testimonials-widget/" target="_blank">
									<?php
									_e(
										'More Details',
										'memberlite'
...
?>
							...
							<div class="action-links">
								<ul class="plugin-action-buttons">
									<li>
										<a class="install-now button" href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&s=woocommerce' ) ); ?>">
																						<?php
																						_e(
																							'Install Now',
																							'memberlite'
...
?>
								...
								<p><a href="<?php echo esc_url( admin_url( 'plugin-install.php?tab=search&type=term&s=Paid+Memberships+Pro+-+WooCommerce+Add+On' ) ); ?>">
														<?php
														_e(
