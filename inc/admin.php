...
function memberlite_theme_menu() {
	add_theme_page('Member Lite Documentation and Support', 'Member Lite', 'edit_theme_options', 'memberlite-support', 'memberlite_support');
}
...
function memberlite_support() {
	...
	<div id="wpbody-content" aria-label="Main content" tabindex="0">	
		<div class="wrap"><div class="metabox-holder">
			<h2>Member Lite Theme Documentation and Support</h2>
			<?php if(empty($key)) { ?>
			<div class="error">
					...
					<div class="postbox">
						...
						<div class="inside">
							...
							<?php } elseif(!pmpro_license_isValid(NULL, 'plus')) { ?>
								<div class="notice notice-error inline"><p><strong>The Member Lite theme requires a PMPro Plus license. You will have to <a href="http://www.paidmembershipspro.com/login/?redirect_to=/membership-account/membership-checkout/?level=20">upgrade your PMPro license</a> to receive automatic updates.</p></div>
							<?php } else { ?>													
			...
			<?php if($view == 'docs') { ?>
				<div id="memberlite-shortcodes">
					...
					?>
					<a href="http://demo.paidmembershipspro.com/memberlite/documentation/adding-your-logo/" target="_blank">Explore Documentation on Custom Headers in Member Lite &raquo;</a></p>
					<hr />
					...
					<p><a href="<?php echo wp_customize_url (); ?>">Customize Your Theme &raquo;</a> &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp; <a href="http://demo.paidmembershipspro.com/memberlite/documentation/customize-the-theme/" target="_blank">Explore Documentation on Customizing Member Lite &raquo;</a></p>
					<hr />
					...
					<hr />
					<h3>Shortcodes</h3>
					<p>Member Lite shortcodes enhance the appearance of your site content and can be used to  customize the display of Paid Memberships Pro-generated pages. Shortcodes are included for:</p>
					<ul class="ul-disc">
					...
					<p>Member Lite includes formatting for use with:</p>
					<ul class="ul-disc">
