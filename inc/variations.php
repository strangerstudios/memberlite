...
function memberlite_the_header_edit_link( string $post_name ): void {
	...
	$pencil_icon = '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
	...
	echo '<a href="' . esc_url( $edit_url ) . '">'. $pencil_icon . esc_html__( 'Edit Header', 'memberlite' ) . '</a>';
	echo '</div>';
}
...
function memberlite_the_footer_edit_link( string $post_name ): void {
	...
	echo '<a href="' . esc_url( $edit_url ) . '">'. $pencil_icon . esc_html__( 'Edit Footer', 'memberlite' ) . '</a>';
	echo '</div>';
}
