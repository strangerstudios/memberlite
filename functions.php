...
function memberlite_widgets_init() {
	...
	register_sidebar(
		array(
			...
			'id'            => 'sidebar-4',
			'description'   => __( 'This is a legacy method to customize the site footer. For more control, create a new Footer Variation and assign it in Customizer settings.', 'memberlite' ) . ' <a href="https://memberlitedev.local/wp-admin/edit.php?post_type=memberlite_footer" target="_blank">' . __( 'Edit Footer Patterns', 'memberlite' ) . '</a>',
