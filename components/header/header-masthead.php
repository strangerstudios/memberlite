...
$banner_content_alignment = get_post_meta( get_the_id(), '_memberlite_banner_text_alignment', true );
$banner_content_classes   = $banner_content_alignment === 'centered' ? 'text-center' : '';

if ( $should_render_masthead ) { ?>

	<?php do_action( 'memberlite_before_masthead_outer' ); ?>

	<div class="masthead <?php echo esc_attr( $banner_content_classes ); ?>">
