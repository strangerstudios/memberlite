<?php
/**
 * Memberlite Pattern: Newsletter Subscribe
 *
 * @since TBD
 */

return [
	'title'       => __( 'Newsletter Subscribe', 'memberlite' ),
	'description' => __( 'A call-to-action section encouraging visitors to subscribe to your paid newsletter.', 'memberlite' ),
...
<div class="wp-block-group alignfull has-white-color has-color-primary-background-color has-text-color has-background" style="padding-top:var(--wp--preset--spacing--60);padding-right:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--60);padding-left:var(--wp--preset--spacing--30)">
	...
	<div class="wp-block-columns are-vertically-aligned-center alignwide">
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:65%">
			...
			<h2 class="wp-block-heading has-36-font-size">' . __( 'Get the Weekly Insider Newsletter', 'memberlite' ) . '</h2>
			<!-- /wp:heading -->
			<!-- wp:paragraph {"fontSize":"18"} -->
			<p class="has-18-font-size">' . __( 'Every week, we deliver actionable insights, curated links, and exclusive analysis straight to your inbox. Join thousands of professionals who start their week with us.', 'memberlite' ) . '</p>
			<!-- /wp:paragraph -->
		</div>
		<!-- /wp:column -->
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:35%">
			...
			<div class="wp-block-group">
				...
				<div class="wp-block-group">
					...
					<p class="has-16-font-size">' . __( 'Exclusive member-only content', 'memberlite' ) . '</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
				<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|10"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
				<div class="wp-block-group">
					...
					<!-- /wp:paragraph -->
					<!-- wp:paragraph {"fontSize":"16"} -->
					<p class="has-16-font-size">' . __( 'Early access to new features', 'memberlite' ) . '</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
				<!-- wp:group {"style":{"spacing":{"blockGap":"var:preset|spacing|10"}},"layout":{"type":"flex","flexWrap":"nowrap"}} -->
				<div class="wp-block-group">
					...
					<!-- /wp:paragraph -->
					<!-- wp:paragraph {"fontSize":"16"} -->
					<p class="has-16-font-size">' . __( 'Cancel anytime, no commitment', 'memberlite' ) . '</p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
			...
			<div class="wp-block-buttons">
				...
				<div class="wp-block-button has-custom-width wp-block-button__width-100 is-style-outline"><a class="wp-block-button__link wp-element-button" href="#">' . __( 'Subscribe Now', 'memberlite' ) . '</a></div>
				<!-- /wp:button -->
			</div>
			<!-- /wp:buttons -->
		</div>
