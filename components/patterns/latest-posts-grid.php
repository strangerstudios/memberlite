<?php
/**
 * Memberlite Pattern: Latest Posts Grid
 *
 * @since TBD
 */

return [
	'title'       => __( 'Latest Posts Grid', 'memberlite' ),
	'description' => __( 'Display your latest blog posts in a three-column grid with featured images, titles, dates, and excerpts.', 'memberlite' ),
	'categories'  => [ __( 'memberlite-content', 'memberlite' ) ],
	'keywords'    => [
		__( 'blog', 'memberlite' ),
		__( 'posts', 'memberlite' ),
		__( 'news', 'memberlite' ),
		__( 'articles', 'memberlite' ),
...
<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--70);padding-bottom:var(--wp--preset--spacing--70)">
	...
	<h2 class="wp-block-heading has-text-align-center">' . __( 'Latest Articles', 'memberlite' ) . '</h2>
	<!-- /wp:heading -->
	<!-- wp:paragraph {"align":"center","fontSize":"18"} -->
	<p class="has-text-align-center has-18-font-size">' . __( 'Stay up to date with the latest news, insights, and stories from our community.', 'memberlite' ) . '</p>
	<!-- /wp:paragraph -->
	...
	<div class="wp-block-buttons">
		...
		<div class="wp-block-button"><a class="wp-block-button__link has-color-primary-background-color has-background wp-element-button" href="#">' . __( 'View All Articles', 'memberlite' ) . '</a></div>
		<!-- /wp:button -->
	</div>
	<!-- /wp:buttons -->
</div>
